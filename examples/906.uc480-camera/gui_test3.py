...
class App:
    def __init__(self, window, window_title, video_source=0):
        ...
        self.canvas_1 = tkinter.Canvas(
            self.frame_1, width=self.vid_1.width, height=self.vid_1.height
        )
        # self.canvas.pack()
        self.canvas_1.grid(
            row=0,
        ...
        self.pic_btn_1 = tkinter.Button(
            self.frame_1, text="Snapshot", command=self.snapshot_1
        )
        self.pic_btn_1.grid(row=0, column=3, pady=4, sticky=tkinter.W)

        self.rec_btn_1 = tkinter.Button(
            self.frame_1, text="Record", command=self.record_1
        )
        ...
        self.expo_slider_1 = tkinter.Scale(
            self.frame_1, from_=0, to=30, command=self.set_exposure_1
        )
        self.expo_slider_1.set(15)
        self.expo_slider_1.grid(row=5, column=3, pady=4, sticky=tkinter.W)

        self.color_1 = tkinter.IntVar()
        self.color_check_1 = tkinter.Checkbutton(
            self.frame_1,
            text="Color",
            variable=self.color_1,
            onvalue=1,
            offvalue=0,
            command=self.set_color_1,
        )
        self.color_check_1.grid(row=2, column=3, pady=4)

        self.col_btn_1 = tkinter.Button(
            self.frame_1, text="Filter", command=self.select_filter_1
        )
        self.col_btn_1.grid(row=3, column=3, pady=4, sticky=tkinter.W)

        self.brow_btn_1 = tkinter.Button(
            self.frame_1, text="Browse", command=self.browse_files
        )
        ...
        self.canvas_2 = tkinter.Canvas(
            self.frame_2, width=self.vid_2.width, height=self.vid_2.height
        )
        # self.canvas.pack()
        self.canvas_2.grid(
            row=0,
        ...
        self.pic_btn_2 = tkinter.Button(
            self.frame_2, text="Snapshot", command=self.snapshot_2
        )
        self.pic_btn_2.grid(row=0, column=3, pady=4, sticky=tkinter.W)

        self.rec_btn_2 = tkinter.Button(
            self.frame_2, text="Record", command=self.record_2
        )
        ...
        self.expo_slider_2 = tkinter.Scale(
            self.frame_2, from_=0, to=30, command=self.set_exposure_2
        )
        self.expo_slider_2.set(15)
        self.expo_slider_2.grid(row=5, column=3, pady=4, sticky=tkinter.W)

        self.color_2 = tkinter.IntVar()
        self.color_check_2 = tkinter.Checkbutton(
            self.frame_2,
            text="Color",
            variable=self.color_2,
            onvalue=1,
            offvalue=0,
            command=self.set_color_2,
        )
        self.color_check_2.grid(row=2, column=3, pady=4)

        self.col_btn_2 = tkinter.Button(
            self.frame_2, text="Filter", command=self.select_filter_2
        )
        self.col_btn_2.grid(row=3, column=3, pady=4, sticky=tkinter.W)

        self.brow_btn_2 = tkinter.Button(
            self.frame_2, text="Browse", command=self.browse_files
        )
...
class MyVideoCapture:
    ...
    def init_camera(self):
        ...
        try:
            ...
            raise Exception(
                "Camera with serial number " + str(self.ser_num) + " could not be found"
            )
                ...
                (
                    np.dstack(
                        (
                            ...
                            (bayer_T * (self.filter[0] / 255)) * (BRIGHTNESS / 5),
                        )
                    )
                ),
                0,
