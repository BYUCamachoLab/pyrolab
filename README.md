...
using a production grade server. To see how it looks, and run the development
server, simply run:

```
flask --app tapeouttools run --debug
```

Production uses should use a more resilient server. Read more about it in the 
[Flask docs](https://flask.palletsprojects.com/en/2.2.x/deploying/).
